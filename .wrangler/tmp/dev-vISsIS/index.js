...
app.get(
  ...
  upgradeWebSocket((c) => {
    ...
    return {
      ...
      onMessage: /* @__PURE__ */ __name((evt, ws) => {
        try {
          isAlive = true;
          let messageData;
      ...
      onClose: /* @__PURE__ */ __name((evt, ws) => {
        console.log(
          `WebSocket connection closed for ${connectionId}: Code ${evt.code}, Reason: ${evt.reason?.toString()}`
        );
        isAlive = false;
      }, "onClose"),
      onError: /* @__PURE__ */ __name((evt, ws) => {
...
// ../../../../../home/cristminix/.nvm/versions/node/v22.18.0/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../../home/cristminix/.nvm/versions/node/v22.18.0/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-qDMJVp/middleware-insertion-facade.js
...
// ../../../../../home/cristminix/.nvm/versions/node/v22.18.0/lib/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-qDMJVp/middleware-loader.entry.ts
